...
import com.example.dpulog.Adapter.CommentAdapter
...
class CommentsActivity : AppCompatActivity()
{
    ...
    private var commentList: MutableList<com.example.dpulog.Model.Comment>? = null
        ...
        commentsRef.addValueEventListener(object : ValueEventListener
        {
            override fun onDataChange(p0: DataSnapshot)
            {
                if (p0.exists())
                {
                    ...
                    {
                        val comment = snapshot.getValue(com.example.dpulog.Model.Comment::class.java)
    ...
    private fun addNotification()
    {
        ...
        notiMap["text"] = "yorum yaptı: " + add_comment!!.text.toString()
